package com.hxminco.mock.comm.utils.winxin;
...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
        ...
        private static String key = "AbLcgP4rPQn3MPFFCD5QdYsGe2PNvgGK";

        //微信分配的公众号ID（开通公众号之后可以获取到）
        private static String appID = "wx70109145d6974c9c";

        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        private static String mchID = "1231481202";
        ...
        //回调地址
        public static String NOTIFY_URL = "http://localhost:8180/mock/wxNotify.html"; //测试
