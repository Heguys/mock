...
import com.hxminco.mock.comm.utils.WXPayConstants;
import com.hxminco.mock.comm.utils.weixin.GetWxOrderno;
import com.hxminco.mock.comm.utils.weixin.RequestHandler;
import com.hxminco.mock.comm.utils.weixin.Sha1Util;
import com.hxminco.mock.comm.utils.weixin.TenpayUtil;
...
public class WeixinPayController {
    ...
    //商户相关资料
    private static String appid = WXPayConstants.appid;
    private static String appsecret = WXPayConstants.appsecret;
    private static String partner = WXPayConstants.partner;
    private static String partnerkey = WXPayConstants.partnerkey;
    ...
    public void topay(HttpServletRequest request,HttpServletResponse response) throws Exception{
        ...
        String notify_url = WXPayConstants.notify_url;//微信异步通知地址
        ...
        String createOrderURL = WXPayConstants.createOrderURL;
        String prepay_id="";
        try {
        ...
        finalpackage.put("partnerid", WXPayConstants.partner);
        ...
        retMsgJson.put("partnerid", WXPayConstants.partner);
